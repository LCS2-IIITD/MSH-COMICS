...
Original file is located at
    https://colab.research.google.com/drive/1UBJK4ac0ypQJPx5Z2NxhfWjkUZW7n06E
"""
...
os.chdir('/content/drive/My Drive/Sarcasm')
...
import pickle
f=open('/content/drive/My Drive/Sarcasm/Dataset_final.p','rb')
...
embedding=[]
for i in d_final3.index:
  embedding.append(d_final3['Audio_features'][i])
...
for i in range(0,len(data)):
  if i<10:
    ...
    list6=[]
    list6.append(data[i])
    list6.append(data[i-1])
    list6.append(data[i-2])
    list6.append(data[i-3])
    list6.append(data[i-4])
    list6.append(data[i-5])
    list6.append(data[i-6])
    list6.append(data[i-7])
    list6.append(data[i-8])
    list6.append(data[i-9])
  d.insert(i,np.array(list6))
d=np.array(d)
data=d
